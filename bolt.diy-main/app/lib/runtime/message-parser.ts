...
const PROCESSING_BATCH_SIZE = 20; // Process more messages per batch
const DEBOUNCE_DELAY = 8; // Faster UI updates (~120fps)
const USE_PARALLEL_PROCESSING = navigator.hardwareConcurrency > 4; // Use parallel processing on powerful PCs
